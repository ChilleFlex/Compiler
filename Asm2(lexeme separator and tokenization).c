...
int main(){
    char c;
    char sourceFileName[30] = "Asm2_Input.txt";
    char tempFileName[30] = "Asm2_temp.txt";
    char targetFileName[30] = "Asm2_output.txt";
    ...
    if(source == NULL || target == NULL || temp == NULL){
        ...
        while( (c = fgetc(source)) != EOF ){
            ...
            if(lexemeStart == 1){
                ...
                else if(c == '>' || c == '<' || c == '!' || c == '|' || c == '&' || c == '='){           //This section is done for apostrophe
                    fputc(' ',temp);
                    fputc(c,temp);
                    lexemeStart = 0;
